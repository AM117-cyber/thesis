...
\newcommand{\evidencIA}[1]{\textcolor{blue}{\uppercase{\bf #1}}}

\newcommand{\comadreja}[1]{{\fcolorbox{white}{black}{\textcolor{white}{\bf #1}}}}

\newcommand{\oracionlarga}[1]{{\color{Thistle} [#1$^{\text{largo}}$]}}
